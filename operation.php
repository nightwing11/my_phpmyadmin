...
if (isset($_POST["nom_table"])) {
    $db = new PDO('mysql:host=localhost;dbname='. $_POST["dbname"] .';', 'root', '', array(PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8'));
	// $db = new PDO('mysql:host=localhost;dbname='. $_POST["dbname"] .';', 'root', 'root', array(PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8'));
...
if (isset($_POST["nom_db"])) {
	$base = new PDO('mysql:host=localhost;dbname='. $_POST["dbname"] .';', 'root', '', array(PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8'));
    // $base = new PDO('mysql:host=localhost;dbname='. $_POST["dbname"] .';', 'root', 'root', array(PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8'));
